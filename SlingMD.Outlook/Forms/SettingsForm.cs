...
namespace SlingMD.Outlook.Forms
{
    public partial class SettingsForm : Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.lblDefaultNoteTags = new Label { Text = "Default Note Tags (comma-separated):", Anchor = AnchorStyles.Left };
            this.txtDefaultNoteTags = new TextBox { Anchor = AnchorStyles.Left | AnchorStyles.Right, Width = 320 };
            noteTagLayout.Controls.Add(this.lblDefaultNoteTags, 0, 0);
            noteTagLayout.Controls.Add(this.txtDefaultNoteTags, 1, 0);
            this.lblDefaultTaskTags = new Label { Text = "Default Task Tags (comma-separated, will be rendered as #tags):", Anchor = AnchorStyles.Left };
            this.txtDefaultTaskTags = new TextBox { Anchor = AnchorStyles.Left | AnchorStyles.Right, Width = 320 };
            noteTagLayout.Controls.Add(this.lblDefaultTaskTags, 0, 1);
            noteTagLayout.Controls.Add(this.txtDefaultTaskTags, 1, 1);
            this.lblNoteTitleFormat = new Label { Text = "Note Title Format (use {Subject}, {Sender}, {Date}):", Anchor = AnchorStyles.Left };
            this.txtNoteTitleFormat = new TextBox { Anchor = AnchorStyles.Left | AnchorStyles.Right, Width = 320 };
            noteTagLayout.Controls.Add(this.lblNoteTitleFormat, 0, 2);
            noteTagLayout.Controls.Add(this.txtNoteTitleFormat, 1, 2);
            this.lblNoteTitleMaxLength = new Label { Text = "Max Title Length:", Anchor = AnchorStyles.Left };
